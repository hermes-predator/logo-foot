          ...
          <div className="md:transform md:-translate-y-[3rem]">{/* Alignement avec le lecteur vidéo */}
            ...
            <div className="text-left mb-1">
              <div className="flex items-center gap-3">
                ...
                <span className="bg-green-100 text-green-700 text-[9px] sm:text-[10px] font-bold px-1.5 py-0.5 rounded-full">Offre du moment</span>
                <span className="w-px h-5 bg-gray-300"></span>
                <span className="text-xl sm:text-2xl font-extrabold text-red-500 line-through">100€</span>
