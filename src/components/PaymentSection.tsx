    ...
    <div className="max-w-5xl mx-auto px-4 py-6">
      ...
      <div className="grid md:grid-cols-3 gap-6">
        <div className="md:col-span-3">
          <div className="relative p-6 md:p-8 pb-4 rounded-2xl border border-blue-100 bg-gradient-to-b from-blue-50/50 to-white shadow-sm hover:shadow-md transition-all duration-500 ease-out hover:scale-[1.01] hover:border-blue-200">
            ...
            <div className="flex justify-center mt-3 mb-0">
              <div className="inline-flex items-center px-3 py-1 mx-auto">
