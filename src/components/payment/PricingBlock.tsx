...
const PricingBlock = () => {
  return (
    <div className="flex flex-col md:flex-row items-center justify-between p-6 mb-6 rounded-xl bg-gradient-to-b from-white to-amber-50/50 border border-amber-200/30 shadow-md relative overflow-hidden -mt-4 z-30">
      {/* Effet de verre simplifié avec positionnement légèrement plus haut */}
      <div className="absolute inset-0 -top-2 bg-gradient-to-r from-amber-50/20 to-pink-50/20"></div>
        ...
        <div className="flex flex-col md:flex-row items-center gap-3">
          <div>
            ...
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="bg-pink-100 text-pink-800 px-2 py-0.5 rounded-md text-xs font-semibold border border-pink-200 shadow-sm">Valeur réelle</span>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="flex flex-col items-start ml-2">
                <span className="text-amber-600 text-sm font-bold whitespace-nowrap">82% de réduction</span>
        ...
        <div className="group">
          <Tooltip>
            <TooltipTrigger asChild>
              <div className="flex items-center gap-2 px-4 py-2.5 rounded-full bg-gradient-to-r from-amber-100 to-pink-100 hover:from-amber-200 hover:to-pink-200 hover:shadow-sm transition-all duration-300 transform hover:translate-y-[-1px] border border-amber-200/50">
                <RefreshCcw className="h-4 w-4 text-orange-600 group-hover:rotate-180 transition-transform duration-500" />
                <span className="text-sm whitespace-nowrap text-orange-800 font-medium">
            ...
            <TooltipContent className="z-[9999] max-w-[300px] p-4 space-y-2 text-sm bg-white border border-gray-200/70 shadow-md rounded-lg">
              <p className="font-semibold text-amber-700">Votre satisfaction est garantie.</p>
