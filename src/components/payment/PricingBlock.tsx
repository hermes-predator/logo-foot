...
const PricingBlock = () => {
  return (
    <>
      <div className="flex flex-col md:flex-row items-center justify-between p-6 mb-6 rounded-xl bg-transparent border-0 shadow-lg relative overflow-hidden z-30 hover:shadow-xl transition-shadow duration-300">
