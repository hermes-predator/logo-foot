          ...
          <div className="md:transform md:-translate-y-[3rem]">{/* Alignement avec le lecteur vidéo */}
            ...
            <div className="text-left mb-1">
              <div className="flex items-center gap-3">
                ...
                <span className="text-xl sm:text-2xl font-extrabold text-gray-400 line-through">100€</span>
                <span className="bg-red-100 text-red-700 text-[9px] sm:text-[10px] font-bold px-1.5 py-0.5 rounded-full">Valeur véritable</span>
              </div>
            </div>
