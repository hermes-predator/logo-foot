                ...
                <h3 className="font-bold text-black text-lg">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex flex-col">
                      ...
                      <span className="text-sm text-amber-700/90 font-medium mt-1">Téléchargez + de 8600 LOGOS de Clubs de Foot organisés par pays. 
 Obtenez toutes les ressources dans notre fichier ZIP complet.
