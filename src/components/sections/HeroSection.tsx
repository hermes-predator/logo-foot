      ...
      <div className="max-w-5xl mx-auto text-center">
        ...
        <div className="grid md:grid-cols-[11fr_9fr] gap-6 items-center mb-2 relative">
          ...
          <div className="transform -translate-y-12">{/* Alignement ajusté avec le lecteur vidéo */}
            ...
            <div className="space-y-3 text-left">
              <div className="flex items-center gap-3">
                ...
                <span className="text-gray-700 font-medium">Fichier Complet ≃ <span className="font-bold">8 800 logos football</span></span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-5 h-5 bg-green-600 rounded-full flex items-center justify-center flex-shrink-0">
                  <svg className="w-3 h-3 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-gray-900 font-bold text-lg">11.90€</span>
            ...
            <div className="flex flex-col md:flex-row gap-3 items-stretch md:items-center mt-6">
              ...
              <Button
                ...
                title="Paiement sécurisé avec SumUp - 11.90€"
          ...
          <div className="space-y-3 md:space-y-4 md:mt-12">
            ...
            <div className="bg-green-50/90 backdrop-blur-lg rounded-xl px-3 pt-4 pb-3 -mb-1 text-center max-w-md mx-auto transform translate-y-[-4.7rem] shadow-[0_1px_6px_rgba(0,0,0,0.03),0_1px_3px_rgba(0,0,0,0.015),inset_0_1px_0_rgba(255,255,255,0.8)] border border-green-100/50 before:absolute before:inset-0 before:rounded-xl before:p-[1px] before:bg-gradient-to-br before:from-green-100/60 before:via-green-50/40 before:to-green-100/30 before:-z-10 before:m-[-1px] relative">
              {/* Décoration avec icône utilisateurs en haut à droite du container vert */}
              <div className="absolute top-0 right-0 bg-green-600 text-white rounded-bl-xl rounded-tr-xl px-2.5 py-2 shadow-lg">
