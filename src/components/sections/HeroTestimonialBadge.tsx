...
const HeroTestimonialBadge = () => {
  ...
  return (
    <div className="inline-flex items-center gap-3 bg-gradient-to-r from-green-50/80 to-emerald-50/75 backdrop-blur-sm rounded-full px-6 py-3 border border-green-150/65 transition-all duration-500 hover:from-green-50/90 hover:to-emerald-50/85 hover:border-green-150 shadow-sm">
      {/* Avatars empilés */}
      ...
      <div className="flex items-center gap-2 min-w-0">
        ...
        <div className="flex flex-col min-w-0">
          <p className="text-xs text-gray-600 truncate max-w-[420px] font-medium">
