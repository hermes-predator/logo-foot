...
const PaymentTitle = () => {
  return <div className="text-center mb-10 animate-fade-in">
      <h2 className="text-4xl font-bold mb-1 text-gray-900">Prêt à tout recevoir ?</h2>
      <p className="text-gray-700 text-lg mb-12">Recevez notre fichier ZIP instantanément pour <span className="relative inline-block font-bold">
