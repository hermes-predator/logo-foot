        ...
        <section className="py-12 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-600 mb-8">
              La plus grande collection de logos de équipes de foot en haute qualité et uniforme. Plus de 8600 logos de clubs internationaux, les logos des compétitions etc... en format PNG transparent.
            </p>
            <Dialog>
