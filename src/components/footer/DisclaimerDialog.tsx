        ...
        <div className="space-y-6">
          <div className="mt-4 p-5 border border-gray-100 bg-white rounded-xl shadow-sm">
            <div className="flex flex-col sm:flex-row sm:items-start gap-4">
              <div className="bg-gradient-to-br from-blue-100 via-sky-100 to-blue-200 rounded-md p-4 shadow-lg shadow-blue-200/30 flex items-center gap-2 backdrop-blur-sm border border-blue-200/50 flex-shrink-0">
                <AlertTriangle className="w-6 h-6 text-blue-600 drop-shadow-sm" />
              </div>
