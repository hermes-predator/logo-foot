            ...
            <div className="container mx-auto px-4">
              <div className="max-w-7xl mx-auto">
                <FlipBox
                  ...
                  frontDescription={<><strong className="font-extrabold">⦗FRONT-CLOUD⦘~ Football.zip</strong> contient plus de 8 600 logos des clubs de football uniformes, nommés et triés par pays</>}
