        ...
        <div className="flex justify-center gap-8 text-sm text-gray-600">
          ...
          <Dialog>
            ...
            <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
              ...
              ⦗FRONT-CLOUD⦘~ Football.zip est une ressource indépendante, compilée et organisée à des fins d'archivage, de culture visuelle et de création.</p>
              ...
              Nous ne revendiquons aucune affiliation, partenariat ou validation de la part des clubs, compétitions ou organisations citées ou représentées.</p>
