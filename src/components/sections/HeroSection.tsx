...
const HeroSection: React.FC<HeroSectionProps> = ({
  ...
  return <section className="relative pt-12 pb-6 px-2 overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto text-center">
        ...
        <div className="grid md:grid-cols-[11fr_9fr] gap-6 items-center mb-2 relative">
          ...
          <div className="md:transform md:-translate-y-10">{/* Alignement ajusté avec le lecteur vidéo */}
            ...
            <div className="relative bg-white/70 backdrop-blur-lg rounded-2xl p-4 sm:p-6 md:p-8 md:px-12 shadow-[0_1px_4px_rgba(0,0,0,0.02),0_1px_2px_rgba(0,0,0,0.01),inset_0_1px_0_rgba(255,255,255,0.8)] border border-gray-200 before:absolute before:inset-0 before:rounded-2xl before:p-[1px] before:bg-gradient-to-br before:from-white/60 before:via-gray-100/40 before:to-white/30 before:-z-10 before:m-[-1px]">{/* Container brandé avec glassmorphism */}
            {/* Titre principal - H1 */}
          ...
          <div className="space-y-3 md:space-y-4 mt-4">
            ...
            <div className="text-center -mt-8 md:transform md:-translate-y-[60px]">
              <p className="text-[10px] sm:text-xs font-medium text-gray-500">Fichier ZIP téléchargeable • 63 Mo • 8 774 éléments</p>
            </div>
            
            {/* Bloc des avis clients avec container de confiance */}
            <div className="backdrop-blur-lg rounded-xl px-3 pt-1 pb-3 -mb-1 text-center max-w-md mx-auto md:transform md:-translate-y-[3rem] mt-4 shadow-[0_1px_3px_rgba(0,0,0,0.015),0_1px_2px_rgba(0,0,0,0.01),inset_0_1px_0_rgba(255,255,255,0.8)] border border-blue-100 before:absolute before:inset-0 before:rounded-xl before:p-[1px] before:bg-gradient-to-br before:from-teal-100/30 before:via-green-100/40 before:to-emerald-200/50 before:-z-10 before:m-[-1px] relative bg-gradient-to-br from-teal-50/40 via-green-50/50 to-emerald-50/60">
