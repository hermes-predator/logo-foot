...
const FeatureList = () => {
  const features = [
    ...
    },
    {
      ...
      description: "Un fichier rare et incomparable, cette valeur est trouvable nulle part ailleurs."
    },
    {
      icon: Plus,
    ...
    },
    {
      ...
      description: "Un tarif simple afin d'offrir l'accès à cette ressource à un prix abordable (partage)."
    },
    {
      icon: Plus,
