...
const HeroSection: React.FC<HeroSectionProps> = ({
  ...
  return <section className="relative pt-14 pb-12 px-4 overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center space-y-7">
        ...
        <p className="text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed mt-2">La plus grande collection de logo des équipes de foot en haute qualité et uniforme. Plus de 8 600 logo des clubs de foot internationaux, les logos des compétitions... une couverture totale des logos de foot réunie dans un fichier ZIP arborescent.</p>
