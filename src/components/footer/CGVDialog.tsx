    ...
    <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
      ...
      <div className="mt-4 text-sm space-y-4">
        <section>
          ...
          <p>Les présentes conditions générales de vente régissent la vente de produits numériques via logo-foot.com, édité par Hermès Ressources, SIRET 934 410 507 00016, à ses clients.</p>
        </section>
        <section>
