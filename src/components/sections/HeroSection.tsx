      ...
      <div className="max-w-5xl mx-auto text-center">
        ...
        <div className="grid md:grid-cols-[11fr_9fr] gap-6 items-center mb-2 relative">
          ...
          <div className="transform -translate-y-10">{/* Alignement ajusté avec le lecteur vidéo */}
            ...
            <div className="space-y-3 text-left">
              <div className="flex items-center gap-3">
                ...
                <span className="text-gray-700 font-medium">Fichier Premium : 8 774 logos de football</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-5 h-5 bg-green-600 rounded-full flex items-center justify-center flex-shrink-0">
                  <svg className="w-3 h-3 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span className="text-gray-700 font-medium">Ressources uniformes et classés par pays</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-5 h-5 bg-green-600 rounded-full flex items-center justify-center flex-shrink-0">
                  <svg className="w-3 h-3 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-gray-900 font-bold text-lg">5.90€</span>
            ...
            <div className="flex flex-col md:flex-row gap-3 items-stretch md:items-center mt-6">
              ...
              >
                <span className="relative z-10 flex items-center justify-center">
                  <span className="font-semibold">Acheter avec</span>
                  <img 
          ...
          <div className="space-y-3 md:space-y-4 md:mt-12">
            ...
            <div className="text-center -mt-8 transform -translate-y-[72px]">
            ...
            <div className="bg-gradient-to-br from-green-50 to-blue-50 border border-green-200/60 rounded-xl px-3 pt-3 pb-0 -mb-1 text-center max-w-md mx-auto transform -translate-y-16 shadow-sm">
