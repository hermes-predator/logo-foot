...
const GoogleDriveBadge = ({ 
  ...
  return (
    <Badge 
      className={`inline-flex items-center gap-2 px-4 py-2 bg-gray-50 text-gray-600 border border-gray-200/80 hover:bg-gray-100/70 transition-colors duration-300
        shadow-[0_2px_8px_rgba(0,0,0,0.04),0_1px_4px_rgba(0,0,0,0.02)] 
        ${cursorHelp ? 'cursor-help' : ''} ${className}`}
      role="status"
