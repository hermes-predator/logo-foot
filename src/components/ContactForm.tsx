...
const ContactForm = () => {
  return (
    <div className="text-sm text-gray-600 space-y-4">
      ...
      <p className="text-black leading-relaxed text-sm">En cas de questions, vous pouvez d'abord consulter notre FAQ avant de nous contacter.</p>
      
      <p className="text-black leading-relaxed text-sm mb-1">Vous avez passé commande ? Veuillez inclure quelques informations pour nous aider à vous identifier :</p>
