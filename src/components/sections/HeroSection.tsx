  ...
  return <section className="relative pt-8 pb-6 px-4 overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto text-center">
        ...
        <div className="grid md:grid-cols-[11fr_9fr] gap-6 items-center mb-2 relative">
          ...
          <div className="transform -translate-y-16">{/* Ajustement de la position verticale pour aligner avec la vidéo */}
            ...
            <div className="space-y-3 text-left">
              <div className="flex items-center gap-3">
                ...
                <span className="text-gray-700 font-medium">Fichier ≈ 8 774 logos du football</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-5 h-5 bg-green-600 rounded-full flex items-center justify-center flex-shrink-0">
                  <svg className="w-3 h-3 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span className="text-gray-700 font-medium">Format PNG transparent</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-5 h-5 bg-green-600 rounded-full flex items-center justify-center flex-shrink-0">
                  <svg className="w-3 h-3 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="mt-4 flex justify-start">
              <div className="inline-flex items-center gap-2 text-gray-600 text-sm font-medium">
                <div className="relative">
                  ...
                  {/* Effet de pulsation plus lent */}
                  <div className="absolute -inset-0.5 w-3 h-3 bg-green-400/60 rounded-full animate-[ping_2s_cubic-bezier(0,0,0.2,1)_infinite]"></div>
                </div>
