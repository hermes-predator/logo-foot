  ...
  return <section className="relative pt-14 pb-6 px-2 overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto text-center">
        ...
        <div className="grid md:grid-cols-[11fr_9fr] gap-6 items-center mb-2 relative">
          ...
          <div className="md:transform md:-translate-y-[7.5rem]">{/* Alignement avec le lecteur vidéo */}
            ...
            <div className="text-left mb-1">
              <div className="text-[10px] sm:text-xs text-gray-600 font-medium mb-0.5">Valeur du fichier :</div>
              <div className="flex items-center gap-1.5">
                <span className="text-sm sm:text-base text-gray-400 line-through font-medium">100€</span>
                <span className="text-xl sm:text-2xl font-extrabold text-gray-900">9€</span>
                <span className="bg-green-100 text-green-700 text-[9px] sm:text-[10px] font-bold px-1.5 py-0.5 rounded-full">Meilleur prix</span>
              </div>
            </div>
            ...
            <div className="mt-3 text-[10px] sm:text-xs text-gray-500 text-left">
              ...
              <div><span className="text-[8px]">*</span>Le fichier est délivré immédiatement et en toute sécurité</div>
            </div>
