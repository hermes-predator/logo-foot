              ...
              <div className="relative ml-8">
                <TooltipProvider>
                  <Tooltip>
                    ...
                    <TooltipContent side="bottom" sideOffset={4} align="start" className="text-white p-3 border border-gray-600 shadow-lg max-w-xs" style={{ backgroundColor: 'rgb(45, 43, 41)' }}>
