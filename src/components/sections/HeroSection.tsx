      ...
      <div className="max-w-5xl mx-auto text-center">
        ...
        <div className="grid md:grid-cols-[11fr_9fr] gap-6 items-center mb-2 relative">
          ...
          <div className="transform -translate-y-12">{/* Alignement ajusté avec le lecteur vidéo */}
            ...
            <div className="bg-gradient-to-br from-gray-50/90 to-white backdrop-blur-sm rounded-2xl p-8 px-12 shadow-sm border border-gray-100/60">{/* Container brandé */}
            {/* Titre principal - H1 */}
            ...
            <div className="space-y-3 text-left">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="bg-gray-600 text-white text-xs px-2 py-1 rounded-full font-medium">-90%</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row gap-3 items-stretch md:items-center mt-6">
              ...
              <Button
                ...
                title="Paiement sécurisé avec SumUp - 10€"
