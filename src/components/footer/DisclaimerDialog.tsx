...
const DisclaimerDialog = () => {
  ...
  return (
    <Dialog>
      ...
      <DialogContent className={`max-w-2xl ${isMobile ? 'max-h-[90vh] px-4' : 'max-h-[80vh]'} overflow-y-auto bg-gradient-to-b from-white to-gray-50 shadow-xl border-0 rounded-bl-xl rounded-br-xl rounded-tr-xl rounded-tl-none`}>
        <DialogHeader>
        ...
        <div className="space-y-6">
          <div className="mt-4 p-5 border border-gray-100 bg-white rounded-xl shadow-sm">
            <div className="flex flex-col sm:flex-row sm:items-start gap-4">
              <div className="bg-orange-50 p-3 rounded-none border border-orange-200 shadow-sm flex-shrink-0 group-hover:bg-orange-100/30 transition-colors">
