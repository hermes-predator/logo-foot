...
const HeroTestimonialBadge: React.FC<HeroTestimonialBadgeProps> = ({
  ...
  return (
    <div className="flex items-center justify-center">
      <div className={`relative flex flex-col items-center justify-center gap-3 rounded-2xl px-6 py-4 w-full max-w-md mx-auto h-[130px] transform -translate-y-1 transition-all duration-300 ease-in-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-2'}`}>
