                  ...
                  <TooltipTrigger asChild>
                    ...
                    >
                      <Link to="/" className="flex items-center gap-2">
                        ...
                        <div className="absolute top-0 left-0 h-full w-full z-5 block transform -skew-x-12 bg-gradient-to-r from-transparent via-gray-400/30 to-transparent opacity-50 group-hover:animate-shine" />
                      </Link>
                    </Button>
                  </TooltipTrigger>
