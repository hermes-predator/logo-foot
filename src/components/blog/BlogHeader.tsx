...
const BlogHeader = () => {
  ...
  return <div className="max-w-5xl mb-6 pl-4">
              ...
              <TooltipProvider>
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Button asChild className="bg-gradient-to-b from-white to-gray-100 hover:from-gray-50 hover:to-gray-200 whitespace-nowrap text-gray-800 border border-gray-300 h-12 px-8 py-3 text-base relative overflow-hidden shadow-[0_2px_4px_rgba(0,0,0,0.08),inset_0_1px_0_rgba(255,255,255,0.9)] hover:shadow-[0_4px_8px_rgba(0,0,0,0.12),inset_0_1px_0_rgba(255,255,255,0.9)] transition-all duration-200 min-w-52">
                      <a href="/" className="flex items-center gap-2 relative">
                        <Folder className="h-5 w-5 text-amber-600" />
                        <span className="font-medium">Voir le fichier</span>
