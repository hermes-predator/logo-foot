  ...
  return <section className="relative pt-8 pb-6 px-4 overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto text-center">
        ...
        <div className="grid md:grid-cols-2 gap-6 items-center mb-2 relative">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 text-left">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-gray-700 font-medium">8 700+ logos au format PNG</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-5 h-5 bg-green-600 rounded-full flex items-center justify-center flex-shrink-0">
                  <svg className="w-3 h-3 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="hidden md:block absolute left-1/2 top-3/5 transform -translate-x-1/2 -translate-y-1/2 w-px h-32 bg-gradient-to-b from-transparent via-gray-300 to-transparent"></div>
