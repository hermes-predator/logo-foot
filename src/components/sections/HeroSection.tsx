        ...
        <div className="grid grid-cols-1 gap-8 items-center max-w-[58rem] mx-auto">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <span className="text-xs px-2 py-1 bg-red-100 text-red-700 font-semibold rounded-full">Valeur estimée</span>
              <div className="w-px h-6 bg-border" />
              <span className="text-lg font-bold text-navy">8€</span>
               <span className="text-xs px-2 py-1 bg-lime-100 text-lime-700 font-semibold rounded-full">Prestation de service</span>
            </div>
