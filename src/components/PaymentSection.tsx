                ...
                <div className="group">
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <div className="flex items-center gap-2 px-3.5 py-2 rounded-full bg-gradient-to-r from-[#f1f9f1] via-[#e1f7e5] to-[#edfaf4] shadow-sm hover:shadow transition-all duration-300 transform hover:translate-y-[-1px] border-0 hover:border hover:border-emerald-200">
