...
const HeroTestimonialBadge = () => {
  ...
  return (
    <div className="inline-flex items-center gap-3 bg-gradient-to-r from-green-50/90 to-emerald-50/80 backdrop-blur-sm rounded-full px-6 py-3 border border-green-200/60 transition-all duration-500 hover:from-green-50 hover:to-emerald-50 hover:border-green-200 shadow-sm">
      {/* Avatars empilés */}
