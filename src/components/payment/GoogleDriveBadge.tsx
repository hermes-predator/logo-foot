    ...
    <TooltipProvider>
      <Tooltip>
        <TooltipTrigger asChild>
          <Badge 
            className="inline-flex items-center gap-2 px-3 py-1.5 mt-2 bg-blue-50 text-blue-600 border border-blue-200 shadow-sm hover:bg-blue-100/70 transition-all duration-200 cursor-pointer hover:shadow-md"
          >
