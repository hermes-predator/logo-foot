      ...
      <div className="max-w-5xl mx-auto text-center">
        ...
        <div className="grid md:grid-cols-[11fr_9fr] gap-4 items-stretch mb-2 relative">
          ...
          <div>{/* Alignement naturel avec le lecteur vidéo */}
            ...
            <div className="grid grid-cols-4 gap-2.5 sm:gap-3 mb-2 mt-2 max-w-[340px] sm:max-w-[390px]">
              <div className="bg-white rounded px-7 py-1.5 border border-gray-200 shadow-sm flex flex-col items-center justify-center">
