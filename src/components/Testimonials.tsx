      ...
      <div className="w-full px-4 sm:px-2 relative">
        ...
        <div className="flex items-center justify-center mt-8">
          <a 
            ...
            className="inline-flex items-center gap-3 bg-white hover:bg-gradient-to-r hover:from-gray-50 hover:to-white px-5 py-3 rounded-xl border border-gray-100 hover:border-gray-200 transition-all duration-300 group relative overflow-hidden"
          >
