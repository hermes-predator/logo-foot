      ...
      >
        ...
        >
          ...
          <div className="mb-3 relative z-10 mt-0">
            ...
            <p className={`text-gray-600 mb-2 ${isSmallMobile ? "text-xs" : isMobile ? "text-sm" : "font-medium"} transition-colors duration-500 ${isHovered ? 'text-gray-700' : 'text-gray-600'}`}>La plus grande collection de logos de football en haute qualité</p>
