...
const PaymentTrust = () => {
  ...
  return (
    <div className="flex items-center justify-center mt-6 flex-wrap gap-2">
      ...
      {/* Compteur de téléchargement évolutif avec icône style cloud-like - sans bordure */}
      <div className="inline-flex items-center gap-2 p-1.5 bg-gray-50 rounded-lg">
        <div className="w-6 h-6 flex items-center justify-center bg-gradient-to-b from-white to-white/90 rounded-full p-1 shadow-sm">
