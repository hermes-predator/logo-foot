...
const GoogleDriveBadge = ({ 
  ...
  return (
    <Badge 
      className={`inline-flex items-center gap-2 px-4 py-2 bg-gray-50 text-gray-600 border border-gray-300/80 hover:bg-gray-100/70 transition-all duration-300
        shadow-[0_2px_8px_rgba(0,0,0,0.04),0_1px_3px_rgba(0,0,0,0.08)] 
        hover:shadow-[0_4px_16px_rgba(0,0,0,0.08),0_2px_6px_rgba(0,0,0,0.12)] 
        ${cursorHelp ? 'cursor-help' : ''} ${className}`}
      role="status"
