  ...
  return (
    <div className="space-y-4 mt-6">
      <Tooltip>
        <TooltipTrigger asChild>
          <Button 
            ...
            aria-label="Procéder au paiement sécurisé de 12,90€"
          >
            <ButtonEffects />
      ...
      <div className="sr-only">
        Ce bouton vous permet d'acheter et télécharger immédiatement la collection de logos de football pour 12,90€. 
