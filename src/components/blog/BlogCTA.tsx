    ...
    <section className="w-full py-8">
      <div className="container max-w-4xl mx-auto px-4 relative">
        <div className="flex flex-col items-center justify-center mb-8 text-center">
          ...
          <p className="text-gray-500 text-base max-w-3xl mx-auto whitespace-nowrap overflow-hidden text-overflow-ellipsis">+8 600 logos de football compartimentalisés réunie dans un fichier .zip</p>
        </div>
