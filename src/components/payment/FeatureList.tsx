...
const FeatureList = () => {
  const features = [
    ...
    },
    {
      ...
      description: "Un fichier d'une valeur incomparable et qui est trouvable nulle part ailleurs."
    },
    {
      icon: Plus,
    ...
    },
    {
      ...
      description: "Un tarif simple afin de permettre l'accès à cette ressource pour un prix abordable (partage)."
    },
    {
      icon: Plus,
