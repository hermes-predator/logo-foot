      ...
      <div className="max-w-5xl mx-auto text-center">
        ...
        <div className="grid md:grid-cols-[11fr_9fr] gap-6 items-center mb-2 relative">
          ...
          <div className="space-y-3 md:space-y-4 md:mt-12">
            ...
            <div className="bg-white/80 rounded-xl p-3 text-center max-w-md mx-auto transform -translate-y-20">
              {/* Texte "Derniers avis clients" avec icône utilisateurs */}
              <div className="flex justify-center items-center gap-1 mb-2 text-xs text-black font-extrabold translate-y-5">
