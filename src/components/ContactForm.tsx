      ...
      <div className="space-y-4">
          ...
          <div className="flex flex-col items-center p-5">
            ...
            <div className="text-center mb-6">
              <div className="text-sm text-gray-600">
                Une <FAQDialog asLink={true} onContactClose={onClose} /> est disponible pour répondre aux questions fréquentes.
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 transition-all duration-300">
          ...
          <div className="bg-gradient-to-r from-blue-50 to-gray-100 p-4 rounded-t-xl">
            <p className="text-gray-800 font-semibold mb-3 text-base">Déjà client ? Veuillez inclure vos informations :</p>
