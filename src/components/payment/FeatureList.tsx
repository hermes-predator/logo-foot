  ...
  return (
    <div className="flex items-center gap-4 text-gray-800 p-2 rounded-lg">
      ...
      <div>
        ...
        {description && (
          <p className="text-xs text-gray-500 mt-0.5 leading-tight max-w-[260px]">{description}</p>
        )}
      </div>
    </div>
  );
  ...
  const features = [
    {
      ...
      description: "Une couverture totale du football qui s'ajoute à vos actifs"
    },
    {
      icon: TrendingUp,
      text: "Gain de temps", 
      ...
      description: "Accédez instantanément à toutes les ressources sans recherche fastidieuse"
    },
    {
      icon: Star,
