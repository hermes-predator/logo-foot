          ...
          <div>{/* Alignement naturel avec le lecteur vidéo */}
            ...
            <div className="grid grid-cols-4 gap-1.5 sm:gap-2 mb-2 mt-2 max-w-[380px] sm:max-w-[450px]">
              ...
              <div className="bg-white rounded px-8 py-1.5 border border-gray-200 shadow-sm flex flex-col items-center justify-center">
                ...
                <div className="text-[7px] sm:text-[9px] text-gray-600 font-medium leading-tight whitespace-nowrap">Fichiers centralisés</div>
              </div>
              <div className="bg-white rounded px-8 py-1.5 border border-gray-200 shadow-sm flex flex-col items-center justify-center">
                <div className="text-sm sm:text-base font-bold text-gray-900">+BONUS</div>
                <div className="text-[7px] sm:text-[9px] text-gray-600 font-medium leading-tight whitespace-nowrap">Fichiers bonus</div>
              </div>
            </div>
            ...
            <div className="mt-2 text-[8px] sm:text-[10px] text-gray-500 text-left space-y-0.5">
              <div className="font-bold text-gray-700 mb-1 text-[9px] sm:text-[11px]">Bon à savoir :</div>
              <div>◼︎ Logo-foot.com est un site français fiable et sécurisé : <span className="font-bold">contact@logo-foot.com</span></div>
              <div>◼︎ Le fichier est délivré immédiatement, inscription non requise</div>
            </div>
