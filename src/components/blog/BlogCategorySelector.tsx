...
const BlogCategorySelector = ({ 
  ...
  return (
    <>
      ...
      <div className="mb-8 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-6 shadow-md border border-blue-100 overflow-hidden relative">
      ...
      {currentDescription && (
        <div className="bg-blue-50 border border-blue-100 rounded-lg p-4 mb-8 animate-fade-in">
