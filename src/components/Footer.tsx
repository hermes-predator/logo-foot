            ...
            <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
              ...
              <div className="mt-4 text-sm space-y-4">
                ...
                <section>
                  ...
                  <p>Ce fichier est un produit numérique mis à disposition à des fins strictement personnelles, éducatives ou créatives.
*</p>

                  <p>⦗FRONT-CLOUD⦘~ Football.zip est une ressource indépendante, compilée et organisée à des fins d'archivage, de culture visuelle et de création.
*</p>

                  <p>Aucune ressource présente dans ce fichier n'est vendue en tant que marque déposée, logo officiel ou fichier sous licence commerciale.
*</p>

                  <p>Nous ne revendiquons aucune affiliation, partenariat ou validation de la part des clubs, compétitions ou organisations citées ou représentées.
*</p>

                  <p>Le pack n'est pas destiné à un usage commercial ou à une revente des éléments qu'il contient.
*</p>

                  <p>Tout utilisateur est invité à respecter les droits de propriété intellectuelle des marques concernées dans le cadre de ses projets personnels.
*</p>
                </section>
