...
const GoogleDriveBadge = () => {
  return <Badge className="inline-flex items-center gap-2 px-3 py-1.5 mt-2 bg-blue-50 text-blue-600 border border-blue-200 hover:bg-blue-100/70 transition-colors duration-200">
