      ...
      >
        <div 
          className={`relative backface-hidden p-3 sm:p-5 md:p-7 pb-0 rounded-2xl bg-gradient-to-b from-blue-50/90 to-white border border-blue-100/60 
            ...
            before:absolute before:inset-0 before:rounded-2xl before:shadow-[0_8px_30px_rgba(100,149,237,0.15)] before:opacity-0 before:transition-opacity before:duration-100
            ${isHovered ? 'before:opacity-100' : 'before:opacity-0'}
          `}
          style={{
            boxShadow: isHovered ? 
              '0 20px 50px -15px rgba(100, 149, 237, 0.18), 0 10px 25px -10px rgba(100, 149, 237, 0.12)' : 
