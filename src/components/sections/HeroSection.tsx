        ...
        <div className="flex flex-wrap items-center justify-center gap-6 pt-6">
          <Dialog>
            <DialogTrigger asChild>
              <button 
                className="group flex items-center gap-3 px-11 py-6 bg-gradient-to-r from-gray-50 to-white rounded-lg border border-gray-200/80 hover:border-gray-300 transition-all duration-300 hover:shadow-md relative overflow-hidden"
              >
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button
                ...
                className="bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 shadow-lg hover:shadow-xl transition-all duration-300 text-[22px] gap-5 hover:-translate-y-0.5 px-11 py-6 h-auto relative group overflow-hidden"
              >
