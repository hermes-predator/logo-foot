  ...
  return <section className="relative pt-14 pb-6 px-2 overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto text-center">
        ...
        <div className="grid md:grid-cols-[11fr_9fr] gap-6 items-center mb-2 relative">
          ...
          <div className="md:transform md:-translate-y-16">{/* Alignement avec le lecteur vidéo */}
            ...
            <p className="text-sm sm:text-base md:text-lg text-gray-500 text-left mb-6 sm:mb-8 font-medium">
              Offrez-vous le fichier sur le thème du football le plus complet du marché. Téléchargement instantanée ⚡️
            </p>
