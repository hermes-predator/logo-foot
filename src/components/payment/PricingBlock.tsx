          ...
          <div className="flex flex-col md:flex-row items-center gap-3">
            <div>
              ...
              <div className="flex items-center gap-2">
                <span className="text-4xl md:text-5xl font-extrabold text-gray-900">9.90€</span>
                <div className="flex flex-col items-start ml-2">
                   <span className="text-emerald-600 text-sm font-bold whitespace-nowrap">90% de réduction</span>
