            ...
            <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
              ...
              <div className="mt-4 text-sm space-y-6">
                ...
                <section>
                  ...
                  <p>Après votre paiement, vous recevez immédiatement un lien de téléchargement pour accéder à votre fichier ZIP contenant tous les logos. Tout le travail organisationnel a été réalisé pour vous.</p>
                </section>
