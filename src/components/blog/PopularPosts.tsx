  ...
  return (
    <div className="bg-white rounded-xl p-6 border border-gray-100 shadow-sm mb-6">
        ...
        {popularPosts.map((post, index) => (
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <h4 className="text-sm font-medium text-gray-800 line-clamp-2 group-hover:text-purple-700 transition-colors">
                {post.title}
              </h4>
              <div className="flex items-center gap-1 mt-1">
                ...
                <span className="text-purple-600 text-xs flex items-center opacity-0 group-hover:opacity-100 transition-opacity">
      ...
      <div className="mt-4 text-center">
        <Link 
          to="/blog" 
          className="text-sm text-purple-600 hover:text-purple-800 transition-colors inline-flex items-center gap-1"
        >
