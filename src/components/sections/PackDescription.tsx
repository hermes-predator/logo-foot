  ...
  return (
    <>
      <p className="text-lg font-medium text-gray-800 mb-6">
        Le ⦗FRONT-CLOUD⦘~ Football.zip est un fichier précieux à ajouter à votre patrimoine numérique. Il peut vous apporter beaucoup de valeurs dans vos projets personnels.
      </p>
      ...
      <div className="space-y-8">
        <div className="space-y-4 p-6 rounded-xl bg-gradient-to-br from-purple-50/80 to-purple-50/30 border border-purple-100/80">
          ...
          <div className="grid grid-cols-2 gap-4 bg-white/50 rounded-lg p-4">
            <div>
              <p className="font-semibold text-purple-900">Format :</p>
              <p className="text-purple-700">PNG (fond transparent)</p>
            </div>
            <div>
              <p className="font-semibold text-purple-900">Dimensions :</p>
              <p className="text-purple-700">120px</p>
            </div>
            <div>
              <p className="font-semibold text-purple-900">Sous-groupes :</p>
              <p className="text-purple-700">60 collections</p>
            </div>
            <div>
              <p className="font-semibold text-purple-900">Quantité totale :</p>
              <p className="text-purple-700">8 062 ressources</p>
            </div>
          </div>
          <div className="mt-4">
            ...
            <p className="text-sm leading-relaxed text-purple-700 bg-white/50 rounded-lg p-4">
