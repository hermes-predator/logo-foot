      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <Button 
            ...
            className="w-full bg-gradient-to-b from-blue-500 via-blue-600 to-blue-700 hover:from-blue-600 hover:via-blue-700 hover:to-blue-800 text-white px-8 py-8 text-lg rounded-xl border border-blue-400/60 hover:border-blue-400/70 border-b-[3px] border-b-blue-900/70 border-l-[2px] border-l-blue-700/50 border-r-[2px] border-r-blue-700/50 hover:border-b-blue-900/80 hover:border-l-blue-700/60 hover:border-r-blue-700/60 transition-all duration-300 active:border-b-[1px] active:border-b-blue-900/80 active:translate-y-[2px] active:scale-[0.98] group h-24 relative overflow-hidden will-change-transform shadow-lg hover:shadow-xl"
            style={{
