      ...
      <div className="max-w-5xl mx-auto text-center">
        ...
        <div className="grid md:grid-cols-[11fr_9fr] gap-6 items-center mb-2 relative">
          ...
          <div className="space-y-3 md:space-y-4 md:mt-12">
            ...
            <div className="text-center -mt-8 transform -translate-y-[68px]">
            ...
            <div className="bg-gradient-to-br from-green-50 to-blue-50 border border-green-200/60 rounded-xl px-3 pt-3 pb-0 -mb-1 text-center max-w-md mx-auto transform -translate-y-12 shadow-sm">
