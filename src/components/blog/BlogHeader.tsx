            ...
            <CarouselContent className="-ml-2 md:-ml-4">
              {carouselItems.map(item => <CarouselItem key={item.id} className="pl-2 md:pl-4 basis-1/2">
                  <Link to="/" className="block">
                    <div className="relative aspect-square overflow-hidden bg-gradient-to-br from-orange-50 to-amber-50 rounded-xl hover:shadow-md transition-shadow cursor-pointer">
