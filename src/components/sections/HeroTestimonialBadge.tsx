...
const HeroTestimonialBadge = () => {
  ...
  return (
    <div className="inline-flex items-center gap-3 bg-gradient-to-r from-green-25/95 to-emerald-25/85 backdrop-blur-sm rounded-full px-6 py-3 border border-green-100/70 transition-all duration-500 hover:from-green-25 hover:to-emerald-25 hover:border-green-150 shadow-sm">
      {/* Avatars empilés */}
