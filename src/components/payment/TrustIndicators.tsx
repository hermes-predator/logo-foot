...
const TrustIndicators = () => {
  return (
    <div className="grid grid-cols-3 md:grid-cols-3 gap-4 mb-6">
      <TrustCard 
        icon={
          <div className="bg-gradient-to-br from-blue-900 to-blue-700 bg-clip-text">
            <ShieldCheck className="text-transparent stroke-[1.75px]" />
          </div>
        }
      ...
      <TrustCard 
        icon={
          <div className="bg-gradient-to-br from-blue-900 to-blue-700 bg-clip-text">
            <Download className="text-transparent stroke-[1.75px]" />
          </div>
        }
      ...
      <TrustCard 
        icon={
          <div className="bg-gradient-to-br from-blue-900 to-blue-700 bg-clip-text">
            <HandHeart className="text-transparent stroke-[1.75px]" />
          </div>
        }
...
const TrustCard = ({ icon, title, description }: TrustCardProps) => {
  return (
    ...
    >
      ...
      <div className="w-10 h-10 mb-3 flex items-center justify-center bg-gradient-to-b from-gray-50 to-gray-100 rounded-full p-2 transition-all duration-300 relative z-10 shadow-sm border border-gray-200/50 group-hover:shadow-md" aria-hidden="true">
        {icon}
      </div>
