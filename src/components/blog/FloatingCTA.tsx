...
const FloatingCTA = () => {
  ...
  return (
    ...
    >
      {/* Dégradé similaire au BlogHeader */}
      <div className="relative overflow-hidden">
        {/* Gradient animé en arrière-plan - similaire au BlogHeader */}
              ...
              <div className="relative px-2">              
                ...
                <div className="flex items-center w-full">
                  ...
                  >
                    ...
                    <ArrowRight className="h-3 w-3 transform transition-transform duration-300 group-hover:translate-x-1 relative z-10 text-gray-900" />
              ...
              <div className="flex items-center justify-between px-3 gap-3">
                ...
                <div className="flex items-center">
                  ...
                  >
                    ...
                    <ArrowRight className="h-3 w-3 relative z-10 text-gray-900" />
                  </Button>
              ...
              <div className="flex flex-row items-center justify-between">
                ...
                <div className="flex items-center">
                  ...
                  >
                    ...
                    <ArrowRight className="h-4 w-4 md:h-5 md:w-5 transform transition-transform duration-300 group-hover:translate-x-1 relative z-10 text-gray-900" />
                    <span className="absolute inset-0 bg-gradient-to-r from-transparent via-blue-100/30 to-transparent animate-shine" style={{ animationDuration: '2.5s' }}></span>
                  </Button>
