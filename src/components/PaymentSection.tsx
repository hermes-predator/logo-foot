              ...
              <li className="flex items-center text-gray-600">
                ...
                <Tooltip>
                  ...
                  <TooltipContent className="max-w-[300px]">
                    <p>Votre satisfaction est notre priorité, vous ne prenez aucun risque. Si vous n'êtes pas satisfait, contactez-nous dans les 14 jours suivant votre achat pour un remboursement complet.</p>
                  </TooltipContent>
                </Tooltip>
              </li>
            </ul>
