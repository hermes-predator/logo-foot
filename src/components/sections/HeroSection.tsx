      ...
      <div className="max-w-5xl mx-auto text-center">
        ...
        <div className="grid md:grid-cols-2 gap-6 items-center mb-2 relative">
          ...
          <div className="space-y-3 md:space-y-4 md:mt-12">
            <div className="space-y-1 transform -translate-y-6">
            ...
            <div className="flex flex-col md:flex-row gap-3 md:gap-4 items-stretch md:items-center md:ml-8 transform -translate-y-10">
              <Dialog>
            ...
            <div className="text-center -mt-6">
              <p className="text-sm font-medium text-gray-600 -mt-10">Fichier ZIP téléchargeable • 63 Mo • 8 774 éléments</p>
            </div>
          </div>
        </div>
