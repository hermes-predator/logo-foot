      ...
      {!videoError ? <div className="w-full h-full flex flex-col items-center justify-center p-4 pt-36">
                    ...
                    <Tooltip>
                      ...
                      window.location.href = `https://pay.sumup.com/b2c/QHNJZZLI?return_url=${encodeURIComponent(returnUrl)}`;
                          ...
                          <FileArchive className="h-3.5 w-3.5" />
                              <span>Télécharger ce fichier (11.90€)</span>
                        </button>
                      </TooltipTrigger>
          ...
          window.location.href = `https://pay.sumup.com/b2c/QHNJZZLI?return_url=${encodeURIComponent(returnUrl)}`;
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-blue-500/10 to-indigo-500/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                  <span className="relative z-10 font-bold text-[16px] text-white transition-colors duration-300">Télécharger (11.90€)</span>
            </button>
          </div>
