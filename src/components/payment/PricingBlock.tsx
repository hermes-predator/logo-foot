...
const PricingBlock = () => {
  return (
    <>
      <div className="flex flex-col md:flex-row items-center justify-between p-6 mb-6 rounded-xl bg-gradient-to-br from-white/98 via-blue-50/70 to-white/98 border border-blue-100/40 shadow-md relative overflow-hidden z-30 hover:shadow-lg transition-all duration-300 transform hover:translate-y-[-1px]">
        {/* Effet de verre simplifié avec positionnement légèrement plus haut */}
        <div className="absolute inset-0 -top-2 bg-gradient-to-r from-white/90 via-blue-50/20 to-white/90 backdrop-blur-[1px]"></div>
        
        {/* Bannière de promotion limitée avec texte statique */}
        <div className="absolute top-0 left-0 w-full bg-gradient-to-r from-blue-50/60 via-blue-100/50 to-blue-50/60 py-1 text-center rounded-t-xl">
