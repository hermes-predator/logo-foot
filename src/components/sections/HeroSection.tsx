          ...
          <div>{/* Alignement naturel avec le lecteur vidéo */}
            ...
            <div className="grid grid-cols-4 gap-1.5 sm:gap-2 mb-2 mt-2 max-w-[380px] sm:max-w-[450px]">
              <div className="bg-white rounded px-8 py-1.5 border border-gray-200 shadow-sm flex flex-col items-center justify-center">
                ...
                <div className="text-[7px] sm:text-[9px] text-gray-600 font-medium leading-tight whitespace-nowrap">Fichiers football</div>
              </div>
              <div className="bg-white rounded px-8 py-1.5 border border-gray-200 shadow-sm flex flex-col items-center justify-center">
              ...
              <div className="bg-white rounded px-8 py-1.5 border border-gray-200 shadow-sm flex flex-col items-center justify-center">
                <div className="text-sm sm:text-base font-bold text-gray-900">100%</div>
            ...
            <div className="text-left">
              <div className="flex items-center gap-1.5">
                ...
                <span className="font-serif text-base sm:text-lg font-bold text-gray-900 tracking-tight">8€</span>
