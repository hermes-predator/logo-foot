...
const PricingBlock = () => {
  return (
    <div className="flex flex-col md:flex-row items-center justify-between p-6 mb-6 rounded-xl bg-gradient-to-r from-blue-50/90 via-white/95 to-blue-50/80 backdrop-blur-sm border border-blue-200/60 shadow-lg relative overflow-hidden">
      {/* Effet de glassmorphisme premium */}
      <div className="absolute inset-0 bg-white/20 backdrop-filter backdrop-blur-[2px]"></div>
      ...
      <div className="w-full md:w-auto text-center md:text-left mb-4 md:mb-0 pl-2 md:pl-4 relative z-10">
        <div className="flex flex-col md:flex-row items-center gap-3">
          <div>
            ...
            {/* Nouveau prix avec meilleur contraste et effet de profondeur */}
            <div className="flex items-center gap-2">
              <span className="text-4xl md:text-5xl font-extrabold text-gray-900 drop-shadow-md">8€</span>
              <div className="flex flex-col items-start ml-2">
                <span className="text-emerald-600 text-sm font-bold whitespace-nowrap">84% de réduction</span>
      ...
      <div className="group relative z-10">
        <Tooltip>
          <TooltipTrigger asChild>
            <div className="flex items-center gap-2 px-4 py-2.5 rounded-full bg-gradient-to-r from-green-100 to-emerald-100 hover:from-green-200 hover:to-emerald-200 hover:shadow-md transition-all duration-300 transform hover:translate-y-[-1px] border border-emerald-200/50">
          ...
          <TooltipContent className="max-w-[300px] p-4 space-y-2 text-sm bg-white/95 backdrop-blur-sm border border-gray-200/70 shadow-xl rounded-lg">
