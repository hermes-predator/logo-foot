...
export const southAmericanClubsPost: BlogPost = {
  id: 21,
  title: "Logos du Football Sud-Américain : Design et Passion [2024]",
  excerpt: "Plongez dans l'univers passionnant des logos du football sud-américain. De Boca Juniors à Flamengo, découvrez l'histoire et le design des emblèmes les plus légendaires.",
  date: "2024-03-06",
  content: `Design et Passion en Amérique du Sud

Le football sud-américain se distingue par des logos emblématiques qui racontent l'histoire passionnée de ce continent footballistique.
