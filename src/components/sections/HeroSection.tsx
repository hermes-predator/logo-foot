      ...
      <div className="max-w-5xl mx-auto text-center">
        ...
        <div className="grid md:grid-cols-[11fr_9fr] gap-4 items-stretch mb-2 relative">
          ...
          <div>{/* Alignement naturel avec le lecteur vidéo */}
            ...
            <div className="grid grid-cols-4 gap-0.5 sm:gap-1 mb-2 mt-2 max-w-[292px] sm:max-w-[332px]">
              <div className="bg-white rounded px-1.5 py-1 text-center border border-gray-200 shadow-sm">
