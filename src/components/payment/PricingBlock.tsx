...
const PricingBlock = () => {
  return (
    <div className="flex flex-col md:flex-row items-center justify-between p-5 mb-5 rounded-xl bg-white border border-blue-200/60 shadow-md relative overflow-hidden">
      {/* Effet de verre simplifié - moins coûteux en performance */}
      <div className="absolute inset-0 bg-gradient-to-r from-blue-50/40 to-white/90"></div>
      
      <div className="w-full md:w-auto text-center md:text-left mb-3 md:mb-0 pl-2 md:pl-4 relative z-10">
        <div className="flex flex-col md:flex-row items-center gap-2">
          <div>
            ...
            <div className="flex items-center gap-2">
              <span className="text-4xl md:text-5xl font-extrabold text-gray-900">8€</span>
        ...
        <div className="group">
          <Tooltip>
            <TooltipTrigger asChild>
              <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-green-100 to-emerald-100 hover:from-green-200 hover:to-emerald-200 hover:shadow-sm transition-all duration-300 transform hover:translate-y-[-1px] border border-emerald-200/50">
