    ...
    <div className="max-w-4xl mb-6 pl-4">
      ...
      <div className="relative">
        ...
        <div className="relative bg-gradient-to-br from-white via-white/95 to-gray-50/90 backdrop-blur-sm rounded-2xl p-6 border border-gray-200/80 shadow-lg hover:shadow-xl transition-all duration-300">
          ...
          <div className="bg-gradient-to-r from-white via-white to-gray-50 rounded-xl p-5 border border-amber-200/50 shadow-inner">
                  ...
                  <TooltipTrigger asChild>
                    ...
                    >
                      <Link to="/" className="flex items-center gap-2">
                        ...
                        <div className="absolute top-0 left-0 h-full w-full z-5 block transform -skew-x-12 bg-gradient-to-r from-transparent via-gray-500/30 to-transparent opacity-50 group-hover:animate-shine" />
                      </Link>
                    </Button>
                  </TooltipTrigger>
