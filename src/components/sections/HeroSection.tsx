        ...
        <div className="grid md:grid-cols-2 gap-6 items-center mb-2 relative">
          ...
          <div className="transform -translate-y-24">{/* Ajustement de la position verticale pour remonter encore davantage */}
            ...
            <p className="text-lg md:text-xl text-gray-600 text-left mb-8 font-bold">
              Nous avons développé le fichier sur la thématique du football le plus complet du marché.
            </p>
            ...
            <div className="space-y-3 text-left">
              <div className="flex items-center gap-3">
                ...
                <span className="text-gray-700 font-medium">Fichier de +8 700 logos de football classés par pays</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-5 h-5 bg-green-600 rounded-full flex items-center justify-center flex-shrink-0">
                  <svg className="w-3 h-3 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
