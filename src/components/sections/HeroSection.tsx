  ...
  return <section className="relative pt-14 pb-6 px-2 overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto text-center">
        ...
        <div className="grid md:grid-cols-[11fr_9fr] gap-6 items-center mb-2 relative">
          ...
          <div className="md:transform md:-translate-y-[5rem]">{/* Alignement avec le lecteur vidéo */}
            ...
            <div className="grid grid-cols-4 gap-1.5 sm:gap-2 text-left mb-3 mt-3">
              <div className="bg-white rounded-md p-2 sm:p-2.5 text-center border border-gray-200 shadow-sm">
                ...
                <div className="text-[8px] sm:text-[10px] text-gray-600 font-medium">Livraison immédiate</div>
              </div>
              <div className="bg-white rounded-md p-2 sm:p-2.5 text-center border border-gray-200 shadow-sm">
            ...
            <div className="flex flex-col sm:flex-row gap-3 items-stretch sm:items-center mt-10 mb-6">
              <Dialog>
