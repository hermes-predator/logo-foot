  ...
  return (
    <div className="space-y-4 mt-6">
      <Tooltip>
        <TooltipTrigger asChild>
          <Button 
            ...
            aria-label="Procéder au paiement sécurisé de 6,90€"
          >
            <ButtonEffects />
            ...
            <div className="flex items-center justify-center w-full gap-6 relative z-10">
              ...
              <div className="flex flex-col items-center">
                <span className="text-center font-semibold text-[1.6rem] drop-shadow-sm">
                  {isRedirecting ? "Redirection en cours..." : "Télécharger maintenant (6,90€)"}
                </span>
              </div>
              <ArrowRight 
      ...
      <div className="sr-only">
        Ce bouton vous permet d'acheter et télécharger immédiatement la collection de logos de football pour 6,90 euros. 
