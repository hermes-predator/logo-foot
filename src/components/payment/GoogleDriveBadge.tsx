...
const GoogleDriveBadge = ({ 
  ...
  return (
    <Badge 
      className={`inline-flex items-center gap-2 px-4 py-2 bg-gray-50 text-gray-600 border border-gray-200/60 hover:bg-gray-100/70 transition-colors duration-300
