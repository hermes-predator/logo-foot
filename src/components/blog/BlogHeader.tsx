              ...
              <div className="relative ml-8">
                <TooltipProvider>
                  <Tooltip>
                    ...
                    <TooltipContent side="bottom" className="text-white p-3 border border-gray-600 shadow-lg max-w-xs" style={{ backgroundColor: 'rgb(45, 43, 41)' }}>
                      <div className="text-sm">
                        <div className="font-semibold mb-2">Accès direct au fichier</div>
                        <div className="text-gray-300">Ce fichier est parfaitement organisé et immédiatement utilisable. Vous pouvez le stocker directement sur votre Google Drive, votre ordinateur, votre disque dur et l'utiliser tel quel, sans aucune autre modification.</div>
                      </div>
                    </TooltipContent>
                  </Tooltip>
                </TooltipProvider>
