    ...
    <section className="w-full py-8">
      <div className="container max-w-4xl mx-auto px-4 relative">
        <div className="flex flex-col items-center justify-center mb-8 text-center">
          ...
          <p className="text-gray-500 text-base max-w-3xl mx-auto whitespace-nowrap overflow-hidden text-overflow-ellipsis">8 600+ logos de football prêts à l'emploi réunie dans un seul fichier zip</p>
        </div>
              ...
              <div className="p-5 md:p-7 md:w-2/3">
                ...
                <div className="flex flex-col sm:flex-row gap-2">
                  <Button 
                    asChild 
                    size="default"
                    className="bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-700 hover:to-blue-600 shadow-sm hover:shadow-md transition-all duration-300 w-full sm:w-auto"
                  >
                    <Link to="/">
