  ...
  return (
    <div className="mb-4">
      <div className="flex flex-wrap justify-center gap-3 mb-3">
        {/* Badge Sécurisé */}
        <div className="flex items-center gap-2 px-3 py-2 rounded-full text-white text-sm font-medium" style={{ backgroundColor: 'rgb(21,21,21)', border: '1px solid rgb(21,21,21)' }}>
