      ...
      <div className="max-w-5xl mx-auto text-center">
        ...
        <div className="grid md:grid-cols-[11fr_9fr] gap-6 items-center mb-2 relative">
          ...
          <div className="md:transform md:-translate-y-[3rem]">{/* Alignement avec le lecteur vidéo */}
            ...
            <h1 className="text-sm sm:text-base md:text-lg lg:text-xl font-bold mb-1 leading-tight text-gray-900 text-left">
              <span>
                Tous les <span className="underline">logos des clubs de football</span> en 1 MIN ⏱️:
              </span>
            </h1>
            <p className="text-[10px] sm:text-xs text-gray-600 font-semibold mb-2 text-left">
              Le fichier sur le thème du FOOTBALL le plus complet du marché
            </p>
