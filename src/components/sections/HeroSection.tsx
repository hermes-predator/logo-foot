      ...
      <div className="max-w-5xl mx-auto text-center">
        ...
        <div className="grid md:grid-cols-[11fr_9fr] gap-6 items-center mb-2 relative">
          ...
          <div className="transform -translate-y-12">{/* Alignement ajusté avec le lecteur vidéo */}
            ...
            <div className="bg-gradient-to-br from-gray-50/90 via-white/80 to-green-50/70 backdrop-blur-sm rounded-2xl p-8 px-12 shadow-sm border border-gray-100/60">{/* Container brandé */}
            {/* Titre principal - H1 */}
