        ...
        <div className="grid md:grid-cols-2 gap-6 items-center mb-2 relative">
          ...
          <div className="space-y-4 md:space-y-5">
            <div className="space-y-1">
              ...
              <p className="text-xs md:text-sm text-gray-600 animate-fade-in">➥ Une solution simple qui vous permet d'obtenir tous les logos de clubs de football dans un seul fichier organisé.</p>
            </div>
            <Dialog>
