  ...
  return (
    <div className="space-y-0">
      ...
      <div className="flex flex-col items-center p-5 bg-white rounded-xl shadow-sm border border-gray-200 transition-all duration-300 mb-4">
        ...
        {/* Section informations commande intégrée */}
        <div className="w-full bg-gradient-to-r from-blue-50 to-gray-100 rounded-lg border border-gray-200/50 p-4">
          <p className="text-gray-800 font-bold mb-4 text-lg italic text-center">Vous avez passé commande ? Veuillez inclure ces informations :</p>
        ...
        {/* Mention RGPD intégrée */}
        <div className="w-full mt-4 p-4 bg-gradient-to-r from-gray-50 to-white border border-gray-200/50 rounded-lg">
