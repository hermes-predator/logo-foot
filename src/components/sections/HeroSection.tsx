        ...
        <div className="grid md:grid-cols-2 gap-6 items-center mb-2 relative">
          ...
          <div className="space-y-4 md:space-y-5">
            ...
            <Dialog>
              <DialogTrigger asChild>
                <Button variant="outline" size="lg" className="w-full md:w-auto rounded-xl bg-white hover:bg-gray-50 border-2 border-gray-300 hover:border-gray-400 text-gray-700 font-semibold px-5 py-4 h-auto text-base shadow-[inset_0_0_0_1px_rgba(255,255,255,0.10),inset_0_1px_0_rgba(0,0,0,0.12),inset_0_-1px_0_rgba(255,255,255,0.50),0_2px_6px_rgba(0,0,0,0.06)] mb-2 md:mb-3" aria-label="Ouvrir le descriptif du ZIP">
          ...
          <div className="space-y-2">
            ...
            <div className="bg-white/80 rounded-2xl p-4 text-center max-w-lg mx-auto">
              ...
              <div className="flex justify-center items-center -space-x-2 mb-2 mt-3 flex-wrap">
