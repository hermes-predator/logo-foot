        ...
        <div className="md:col-span-3">
          <div className="relative p-6 md:p-8 rounded-2xl border border-blue-100 bg-gradient-to-b from-blue-50/50 to-white shadow-sm hover:shadow-md transition-all duration-500 ease-out hover:scale-[1.01] hover:border-blue-200">
            ...
            <Button
              ...
              className="w-full bg-blue-600 hover:bg-blue-700 text-white px-8 py-8 text-lg rounded-xl transition-all duration-300 hover:shadow-lg active:scale-95 group disabled:opacity-75 disabled:cursor-not-allowed border-0"
