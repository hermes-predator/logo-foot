  ...
  return <section className="relative pt-8 pb-6 px-4 overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto text-center">
        ...
        <div className="grid md:grid-cols-2 gap-6 items-center mb-2 relative">
          ...
          <div className="space-y-4 transform -translate-y-8">{/* Ajustement de la position verticale */}
            {/* Titre principal - H1 */}
            ...
            {/* Phrase marketing */}
            <p className="text-lg md:text-xl text-gray-600 text-left mb-12 font-bold">
            ...
            <div className="space-y-3 text-left">
              <div className="flex items-center gap-3">
                ...
                <span className="text-gray-700 font-medium">Tous les logos de foot classés par pays</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-5 h-5 bg-green-600 rounded-full flex items-center justify-center flex-shrink-0">
                  <svg className="w-3 h-3 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span className="text-gray-700 font-medium">Plus de 8 700 logos (PNG Transparent)</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-5 h-5 bg-green-600 rounded-full flex items-center justify-center flex-shrink-0">
                  <svg className="w-3 h-3 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
